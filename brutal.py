...
os.system("clear")
autoketik(f"{biru}[{kuning}Warning{biru}] {W}Jangan Lupa Subscribe Channel Syahdan Project")
time.sleep(3)
os.system("xdg-open https://youtube.com/c/SyahdanProject")
...
{abu}-----------------------------------------
{putih}[{biru}•{putih}] {biru}Author {putih}   : Syahdan Fr
{putih}[{biru}•{putih}] {abu}GitHub {putih}   : SyahdanProject
{putih}[{biru}•{putih}] {merah}You{putih}Tube {putih}  : Syahdan Project
{putih}[{biru}•{putih}] {ungu}Instagram {putih}: @syhdnfrahira
